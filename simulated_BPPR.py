...
if __name__ == '__main__':
    ...
    # lon_name = 'lng'
    # lat_name = 'lat'
    points_file = 'E:/ZJU/GitLab/Paper/BatchPointRotation/BPPR/data/data/syntheticData/point300000/point300000.csv'
    # points_file = 'E:/ZJU/GitLab/Paper/BatchPointRotation/EX/data/realData/CASE/occurrence/pbdb_data_occs_Maastrichtian.csv'
